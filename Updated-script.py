...
# List of TIFF files
tif_files = [f"Image_XY01_{str(i).zfill(5)}_CH2.tif" for i in range(1, 10)]  # Adjust range based on your files
...
stitch_images(image_positions, list(image_positions.keys()), nm_per_pixel_values, output_filename)
